...
class modeloconsultar{
	function consultar(){
       ...
       $cons=mysqli_query($cnx,"SELECT datosempresa.nombre_e,piezas.nombre, solde.IDsp,sol.IDsolicitud,datosempresa.IDempresa,solde.fecha_c,solde.fecha_a,solde.estatus 
           ...
           WHERE sol.estatus='1'  AND solde.estatus='0' ORDER BY fecha_c");
